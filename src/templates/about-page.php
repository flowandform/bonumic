...
<main class="about-main">
  ...
  <section class="commercial container">
    <h2 class="commercial__description">
      <span class="commerical__bold">Bonumic</span> is an AI development and research project based in Europe, Croatia. Our mission is to advance the real estate industry by leveraging aritficial intelligence.
    </h2>
  </section>
